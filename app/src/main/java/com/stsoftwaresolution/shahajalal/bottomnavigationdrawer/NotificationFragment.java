...
public class NotificationFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        progressView=view.findViewById(R.id.mainactivityprogressid11);
        recyclerView=view.findViewById(R.id.recyclerviewid111);
    ...
    private void getIngormation(){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("session","seeartsstudents");
                return map;
            }
        };
